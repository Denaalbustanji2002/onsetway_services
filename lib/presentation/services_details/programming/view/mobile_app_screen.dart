...
class _MobileAppScreenState extends State<MobileAppScreen>
  ...
  final _serviceName = "Mobile Application";
  ...
  final List<FeatureCardModel> features = [
    FeatureCardModel(
      ...
      bulletPoints: [
        ...
        "Pharmacies & Medical Apps",
      ],
      icon: Icons.store_outlined,
      image: "assets/programming/mobile app/mobile5.webp",
      accentColor: Colors.blue,
    ),
    FeatureCardModel(
      title: "Features of Onset Way Mobile Apps",
      description: "Cutting-edge technology with enterprise-grade capabilities",
      bulletPoints: [
        "Cross-Platfor3.webpm: Android & iOS ",
        "Custom UI/UX: user-friendly",
